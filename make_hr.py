...
fig.savefig('/mnt/home/npanithanpaisal/gaia/HR_extinction.png', dpi=300)

H_log = np.log10(H)
fig = plt.figure(figsize=((10,8)))
ax = fig.add_subplot(1,1,1)
X, Y = np.meshgrid(e1, e2)
im = ax.pcolormesh(X, Y, H_log, cmap='gist_heat')
ax.set_ylim(-5,17)
plt.gca().invert_yaxis()
ax.set_xlabel('Bp - Rp')
ax.set_ylabel('M_G')
...
fig.colorbar(im, ax =ax)
fig.savefig('/mnt/home/npanithanpaisal/gaia/HR_no_extinction.png', dpi=300)
